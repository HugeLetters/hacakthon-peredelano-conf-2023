...
{#if $report.isSuccess}
	<div class="wrapper">
		...
		<div class="reportData">
			<span>{$report.data?.country}</span>
			<span>{new Date($report.data?.createdAt).toLocaleDateString()}</span>
		</div>
		...
		<a href="/case/{caseId}/report/{reportId}" class="chatLink">
			<svg
				width="36"
				height="36"
				viewBox="0 0 36 36"
